const parser = require('@babel/parser');        // 将js代码转换成ast语法树
const traverse = require('@babel/traverse').default;     // 遍历AST的
...
var jscode = fs.readFileSync('learn_ast/refuse_code1.js',{
    encoding:"utf-8"
});
...
function replace_function_to_string(path){
    ...
    // 查看打印结果
    console.log(node.callee.name,first_arg,second_arg);
...
fs.writeFile('learn_ast/first/decode_code1.js',code,(err)=>{});