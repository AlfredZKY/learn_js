...
jsSHA.prototype = {
    ...
    getHMAC: function (key, inputFormat, variant, outputFormat) {
        var formatFunc, keyToUse, blockByteSize, blockBitSize, i, retVal, lastArrayIndex, keyBinLen, hashBitSize, keyWithIPad = [],
            keyWithOPad = [];
        switch (outputFormat) {
            case "HEX":
                formatFunc = binb2hex;
...
function getPwd(userpassword){
    var js_hash = "711b0e6657";
    return Aes.Ctr.encrypt(userpassword, js_hash, 256);
}

console.log(getPwd('dsadas'));