        ...
        var d = n.CipherParams = o.extend({
            ...
            l = (t.format = {}).OpenSSL = {
                stringify: function (e) {
                    var t = e.ciphertext;
                    return e = e.salt,
                        (e ? i.create([1398893684, 1701076831]).concat(e).concat(t) : t).toString(s)
                },
                parse: function (e) {
                    e = s.parse(e);
                    var t = e.words;
                ...
                _doReset: function () {
                    ...
                    for (e = this._subKeys = [],
                        ...
                        for (var o = e[r] = [], i = u[r], n = 0; 24 > n; n++)
                            o[n / 6 | 0] |= t[(c[n] - 1 + i) % 28] << 31 - n % 6,
                            o[4 + (n / 6 | 0)] |= t[28 + (c[n + 24] - 1 + i) % 28] << 31 - n % 6;
...
console.log(encryptByDES('asdfg'));