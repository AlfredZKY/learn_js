...
navigator={};
function getPrelt() {
    preloginTimeStart = preloginTimeStart = (new Date).getTime();
    return preloginTime = (new Date).getTime() - preloginTimeStart - (parseInt(50, 10) || 0);
}
...
function getPwd(passwd) {
    me = {
        ...
        "loginFormId": "ssoLoginForm",
        "scriptId": "ssoLoginScript",
        "ssoCrossDomainScriptId": "ssoCrossDomainScriptId",
        "loginFrameName": "ssoLoginFrame",
        "appLoginURL": {
        ...
        "isUpdateCookieOnLoad": true,
        "useIframe": true,
        "noActiveTime": 7200,
        "autoUpdateCookieTime": 1800,
        "loginType": 3,
        "timeoutEnable": false,
        "loginTimeout": 5000,
        "crossDomain": true,
        "scriptLoginHttps": false,
        "allowAutoFoundServerTime": false,
        "allowAutoFoundServerTimeError": true,
        "calcServerTimeInterval": 2000,
        "servertime": 1584806399,
        "nonce": "0TXJRL",
        ...
        "crossDomainTime": 5,
        "failRedirect": false,
        "isGenerateVisitor": true,
        "generateVisitorProbability": 1,
        "generateVisitorDelay": 6,
        "generateVisitorDomain": ["^.*sina.com.cn$"],
        "entry": "weibo",
        "vsnf": 1,
        "hold_login_state": false,
        "cookie_timeout": 0,
        "loginSuccessUrl": "//weibo.com/login.php?url=https%3A%2F%2Fweibo.com%2F&comefrom=loginlayer",
        "username": "13756789111",
        "password": "1111",
        "savestate": 7
    }
...
console.log(getPrelt())
console.log(getSu('1111'))
