...
function getPwd(pwd) {
    ...
    n.passwordEncrypted = encryptString(n.timesign + pwd, n.rsaExponent, n.rsaModulus);
    n.p = encryptString(n.timesign + n.mobile, n.rsaExponent, n.rsaModulus);
    return n.passwordEncrypted;
}

console.log(getPwd('11111111'));