...
function getPwd(username, password, captcha) {
    data = {
        ...
        "password": password,
        "captcha": captcha,
        "check_n": "vCL269wKcxkbuvbKwdOFplz4AeeQk781cXqcq+C4q5/4+xUiTBNjWCaNgbJ0mQEIBeiFz6TdHayUsd/eqOroTmjHLYayXZTBunn0OLg4xbkd+GdYRUHnS7fSJAL4UHygTzCGI22Xs1W0jZwTNWj7I0M0VgicrSnQRE9oxBnRRHk=",
        "check_e": "AQAB"
    }
    var kn = data.check_n,
        ke = data.check_e,
...
console.log(getPwd('11111', '1111', '!SCB'))