...
function b(a) {
    ...
    var q = $(".J_FormLogin");
    l.valid.setDefault();
    var r, s, t, u = j.validInfo, v = function(a, b) {
    ...
    }), z = q.find(".J_ValidPsdForm").Validform(y), A = $("#J_AccountType").val();
    1 == A ? (r = "phone",
...
define("lib/artDialog/jquery.artDialog", [], function() {
    !function(a, b, c) {
        ...
        if (p.fn = p.prototype = {
            ...
            size: function(a, b) {
                var c, d, e, f, g = this, h = (g.config,
                g.DOM), j = h.wrap, k = h.main, l = j[0].style, m = k[0].style;
            ...
            _addEvent: function() {
                var a, c = this, d = c.config, e = "CollectGarbage"in b, f = c.DOM;
    ...
    function(a) {
        var b, c, d = a(window), e = a(document), f = document.documentElement, g = !("minWidth"in f.style), h = "onlosecapture"in f, i = "setCapture"in f;
        ...
        c = function(a) {
            var c, f, j, k, l, m, n = artDialog.focus, o = n.DOM, p = o.wrap, q = o.title, r = o.main, s = "getSelection"in window ? function() {
            ...
            c = function() {
                var a, b, c = n.DOM.wrap[0], f = "fixed" === c.style.position, g = c.offsetWidth, h = c.offsetHeight, i = d.width(), j = d.height(), k = f ? 0 : e.scrollLeft(), l = f ? 0 : e.scrollTop(), a = i - g + k;
                return b = j - h + l,
                {
                    minX: k,
                    minY: l,
    ...
    !function(a, b, c) {
        ...
        j.util = {
            ...
            getNullmsg: function(a) {
                var b, c = this, d = /[\u4E00-\u9FA5\uf900-\ufa2da-zA-Z\s]+/g, e = a[0].settings.label || ".Validform_label";
            ...
            getErrormsg: function(b, c, d) {
                var e, f = /^(.+?)((\d+)-(\d+))?$/, g = /^(.+?)(\d+)-(\d+)$/, h = /(.*?)\d+(.+?)\d+(.*)/, j = c.match(f);
                if ("recheck" == d)
